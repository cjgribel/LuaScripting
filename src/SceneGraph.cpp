...
void SceneGraph::traverse(entt::registry& registry)
{
    ...
    tree.traverse_progressive([&](const auto& entity, const auto& entity_parent, size_t node_index, size_t parent_index) {
        ...
        //std::cout << "entity is null " << (entity_parent == entt::null) << ", entity_parent is null " << (entity_child == entt::null) << std::endl;
